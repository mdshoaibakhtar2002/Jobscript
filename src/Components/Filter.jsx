import { Box, FormControl, FormControlLabel, FormLabel, InputLabel, MenuItem, Radio, RadioGroup, Select, Slider } from "@mui/material"
  ...
  return (
    <div className="filter-card">
        <div className="filter">
            ...
            <button className="button black-white margin-top margin-left width">Apply</button>
        </div>
