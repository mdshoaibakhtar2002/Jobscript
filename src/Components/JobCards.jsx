  ...
  return (
    ...
    <div className="card-footer">
        ...
        <div className="apply-now">
            <button className="button" onClick={()=>handleShow("viewDetails")}>View Details</button>
            <button className="button black-white" onClick={()=>handleShow("applyNow")}>Apply Now</button>
        </div>
    </div>
