...
const ChatBubble = () =>{
    ...
    return(
        <Stack position={'fixed'} bottom={'1px'} right={isMobile ?'0' :'10px'} paddingRight={0} width={isMobile ? '100%' :'24rem'} height={showChat === 'block' ? (isMobile ? '100%':'75%'):'4rem'} alignItems={'end'} sx={{transition:'opacity 3s ease-in-out', zIndex:isMobile?9999:'0'}}>
